...
public class FrameOcrSample extends javax.swing.JFrame {
    ...
    void showMessage(final String mesg, final boolean isError) {
        ...
        try{
            JOptionPane.showMessageDialog(FrameOcrSample.this, mesg, "", 
            	//CIRO
            	isError ? JOptionPane.ERROR_MESSAGE : 999); //JOptionPane.INFORMATION_MESSAGE
        } catch (Exception e) { showMessage(mesg, false); }
    }
    ...
    private void initComponents() {
        ...
        panelTop.setBorder(javax.swing.BorderFactory.createTitledBorder("OCR settings:")); //CIRO
