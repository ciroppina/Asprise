...
public class PanelOcrInput extends javax.swing.JPanel {
    ...
    void init() {
        ...
        //CIRO: ADDED
        comboPropsStart.setModel(new DefaultComboBoxModel(new String[] {
                "SPEED_SLOW", "SPEED_FAST", "SPEED_FASTEST", "SPEED_NORMAL"
        }));
        ...
        //CIRO: se ci sono preferenze salvate in precedenza
        if (prefs.get(PREF_PROPS_START, null).trim().length() > 0)
    ...
    private void initComponents() {
        ...
        checkPdfHighlightText.setText("Text layer over PDF");
