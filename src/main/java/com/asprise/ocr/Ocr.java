...
public class Ocr {
    ...
    /** ita (Italian)
    public static final String LANGUAGE_ITA = "ita";  */
    /** eng (English) */
    ...
    public static String getLibraryVersion() {
        //CIRO: return doGetVersion();
        return "OCR Demo by SKM (based on Asprise 15.3)";
    }
    ...
    /** CIRO: per aggiungere una lingua bisogna compilare 
     *  un file [lng].traineddata, da mettere nella cartella
     *  [User]/AppData/Local/380C3DAD/ */
    ...
    public static void main(String[] args) {
        ...
        if (consoleMode != 1) { // double click
           //CIRO: JOptionPane.showMessageDialog(null, version, copyright, JOptionPane.OK_OPTION | JOptionPane.INFORMATION_MESSAGE);
        }
